...
chrome.runtime.sendMessage({ data: 'settingsPopup' }, response => {
    if (!chrome.runtime.lastError) {
        ...
        checkbox6.checked = response.answer.checkbox6
        checkboxAll.checked = checkbox1.checked && checkbox2.checked && checkbox3.checked && checkbox4.checked && checkbox5.checked && checkbox6.checked
